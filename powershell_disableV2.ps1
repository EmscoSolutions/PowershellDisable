...
function EstablishConnectionDelegated {
  ...
  $Session = New-PSSession -ConfigurationName Microsoft.Exchange -ConnectionUri https://ps.outlook.com/powershell-liveid?DelegatedOrg=$DelegatedDomain -Credential $UserCredential -Authentication Basic -AllowRedirection
